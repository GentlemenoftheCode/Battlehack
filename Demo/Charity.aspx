    ...
    <div class="col-md-12 ">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <div style="text-align: left">
                            <asp:Label runat="server" CssClass="label-header">Participate in a Raffle!</asp:Label>
                        </div>
                            ...
                            <div class="col-md-8">
                                ...
                                <div id="paymentArea" class="col-sm-12 text-center paymentArea invisible">
                                    ...
                                    <form id="checkout" method="post" action="/checkout">
                                        ...
                                        <input onclick="submitPayment" runat="server" type="submit">
                                    </form>
        ...
        <script type="text/javascript">
            ...
            function spawnPayment() {
                ...
                if (document.getElementById('MainContent_numTicketsBox').value == 0) {
                    if ($('#paymentArea').hasClass("visible")) {
                        $('#paymentArea').removeClass("visible");
                        $('#paymentArea').addClass("invisible");
                    }
                }
                else if (document.getElementById('MainContent_numTicketsBox').value != "") {
                    ...
                    if ($('#paymentArea').hasClass("visible")) {
                        ...
                        //Set the label to be the price
                        //var numTickets = document.getElementById('MainContent_numTicketsBox').value;
                        //document.getElementById('MainContent_paymentAmount').textContent = numTickets * 5;
